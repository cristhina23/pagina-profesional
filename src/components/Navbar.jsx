...
export default function Navbar() {
    return (
        <motion.nav
            ...
            className="sticky top-0 z-50 bg-background-light/50 dark:bg-background-dark/80 backdrop-blur-xl border-b border-white/5 shadow-2xl shadow-primary/5 px-6 py-4"
        >
            <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-display text-xl uppercase tracking-tighter italic text-slate-800 dark:text-white group cursor-pointer">
